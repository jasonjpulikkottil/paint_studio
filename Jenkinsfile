...
pipeline {
    parameters {
        ...
        string name: 'BUILD_WITH_CATROID', defaultValue: 'no', description: 'When set to \'yes\' the the current paintstudio build will be build with the current develop Branch of Catroid'
    }
    ...
    stages {
        stage('Build Debug-APK') {
            steps {
                ...
                archiveArtifacts 'app/build/outputs/apk/debug/paintstudio-debug*.apk'
                plot csvFileName: 'dexcount.csv', csvSeries: [[displayTableFlag: false, exclusionValues: '', file: 'paintstudio/build/outputs/dexcount/*.csv', inclusionFlag: 'OFF', url: '']], group: 'APK Stats', numBuilds: '180', style: 'line', title: 'dexcount'
            }
        }
        ...
        stage('Build with Catroid') {
            ...
            steps {
                ...
                dir('Catroid') {
                    ...
                    sh "./gradlew -PpaintstudioLocal assembleCatroidDebug"
