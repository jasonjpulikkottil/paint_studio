...
import com.jdots.paint.colorpicker.ColorPickerDialog.Companion.BITMAP_Name_EXTRA
import com.jdots.paint.colorpicker.ColorPickerDialog.Companion.COLOR_EXTRA
...
class ColorPickerPreviewActivity : AppCompatActivity(), OnImageViewPointClickedListener {
    ...
    private fun setCurrentColor(color: Int) {
        currentColor = color
        val checkeredBitmap = BitmapFactory.decodeResource(resources, R.drawable.paintstudio_checkeredbg)
