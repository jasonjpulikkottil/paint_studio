/*
 * paintstudio: An image manipulation application for Android.
...
package com.jdots.paint.colorpicker;
...
import com.jdots.paint.colorpicker.R;

import java.util.Locale;

import static com.jdots.paint.colorpicker.Constants.NOT_A_HEX_VALUE;
...
public class RgbSelectorView extends LinearLayout {
	...
	private void resetTextColor() {
		editTextHex.setTextColor(getResources().getColor(R.color.paintstudio_color_picker_hex_correct_black));
	}

	private void setTextColorToRed() {
		editTextHex.setTextColor(getResources().getColor(R.color.paintstudio_color_picker_hex_wrong_value_red));
	}
