...
import com.jdots.paint.listener.DrawingSurfaceListener;
...
public class DrawingSurface extends SurfaceView implements SurfaceHolder.Callback {
	...
	private void init() {
		backgroundColor = ContextCompat.getColor(getContext(),
				R.color.paint_studio_main_drawing_surface_background);

		framePaint.setColor(Color.BLACK);
		framePaint.setStyle(Paint.Style.STROKE);
		framePaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC));

		Bitmap checkerboard = BitmapFactory.decodeResource(getResources(), R.drawable.paint_studio_checkeredbg);
		...
		DrawingSurfaceListener.AutoScrollTask autoScrollTask = new DrawingSurfaceListener.AutoScrollTask(handler, new AutoScrollTaskCallbackImpl());
