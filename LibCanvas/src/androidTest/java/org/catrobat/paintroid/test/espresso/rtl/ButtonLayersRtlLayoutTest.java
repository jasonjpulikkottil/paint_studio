...
public class ButtonLayersRtlLayoutTest {
	...
	public void testButtonLayers() {
		...
		onView(withId(R.id.paint_studio_nav_view_layer))
				.check(matches(isCompletelyDisplayed()));

		onView(withId(R.id.paint_studio_layer_side_nav_button_add))
				.check(matches(isClickable()))
				.perform(click());
		onView(withId(R.id.paint_studio_layer_side_nav_button_delete))
				.check(matches(isClickable()))
				.perform(click());
	}
}
