...
public class LayerIntegrationTest {
	...
	public void testInitialSetup() {
		...
		onLayerMenuView().onButtonAdd()
				.check(matches(allOf(isEnabled(), withDrawable(R.drawable.ic_paint_studio_layers_add))));
		onLayerMenuView().onButtonDelete()
				.check(matches(allOf(not(isEnabled()), withDrawable(R.drawable.ic_paint_studio_layers_delete_disabled))));
	}
	...
	public void testButtonsAddOneLayer() {
		...
		onLayerMenuView().onButtonAdd()
				.check(matches(allOf(isEnabled(), withDrawable(R.drawable.ic_paint_studio_layers_add))));
		onLayerMenuView().onButtonDelete()
				.check(matches(allOf(isEnabled(), withDrawable(R.drawable.ic_paint_studio_layers_delete))));
		...
		onLayerMenuView().onButtonAdd()
				.check(matches(allOf(not(isEnabled()), withDrawable(R.drawable.ic_paint_studio_layers_add_disabled))));
		onLayerMenuView().onButtonDelete()
				.check(matches(allOf(isEnabled(), withDrawable(R.drawable.ic_paint_studio_layers_delete))));
