package com.jdots.paint.test.presenter;
...
import static com.jdots.paint.common.MainActivityConstants.CREATE_FILE_DEFAULT;
import static com.jdots.paint.common.MainActivityConstants.LOAD_IMAGE_CATROID;
import static com.jdots.paint.common.MainActivityConstants.LOAD_IMAGE_DEFAULT;
import static com.jdots.paint.common.MainActivityConstants.LOAD_IMAGE_IMPORTPNG;
import static com.jdots.paint.common.MainActivityConstants.PERMISSION_EXTERNAL_STORAGE_SAVE;
import static com.jdots.paint.common.MainActivityConstants.PERMISSION_EXTERNAL_STORAGE_SAVE_CONFIRMED_FINISH;
import static com.jdots.paint.common.MainActivityConstants.PERMISSION_EXTERNAL_STORAGE_SAVE_CONFIRMED_LOAD_NEW;
import static com.jdots.paint.common.MainActivityConstants.PERMISSION_EXTERNAL_STORAGE_SAVE_CONFIRMED_NEW_EMPTY;
import static com.jdots.paint.common.MainActivityConstants.PERMISSION_EXTERNAL_STORAGE_SAVE_COPY;
import static com.jdots.paint.common.MainActivityConstants.PERMISSION_REQUEST_CODE_LOAD_PICTURE;
import static com.jdots.paint.common.MainActivityConstants.REQUEST_CODE_INTRO;
import static com.jdots.paint.common.MainActivityConstants.REQUEST_CODE_LOAD_PICTURE;
import static com.jdots.paint.common.MainActivityConstants.RESULT_INTRO_MW_NOT_SUPPORTED;
import static com.jdots.paint.common.MainActivityConstants.SAVE_IMAGE_DEFAULT;
import static com.jdots.paint.common.MainActivityConstants.SAVE_IMAGE_FINISH;
import static com.jdots.paint.common.MainActivityConstants.SAVE_IMAGE_LOAD_NEW;
import static com.jdots.paint.common.MainActivityConstants.SAVE_IMAGE_NEW_EMPTY;
...
public class MainActivityPresenterTest {
	...
	public void testHandleActivityResultWhenUnhandledThenForwardResult() {
		...
		presenter.handleActivityResult(0, AppCompatActivity.RESULT_OK, intent);

		verify(view).superHandleActivityResult(0, AppCompatActivity.RESULT_OK, intent);
	}
	...
	public void testHandleActivityResultWhenUnhandledAndResultNotOKThenForwardResult() {
		...
		presenter.handleActivityResult(0, AppCompatActivity.RESULT_CANCELED, intent);

		verify(view).superHandleActivityResult(0, AppCompatActivity.RESULT_CANCELED, intent);
	}
	...
	public void testHandleActivityResultWhenLoadPictureThenLoadIntentPicture() {
		...
		presenter.handleActivityResult(REQUEST_CODE_LOAD_PICTURE, AppCompatActivity.RESULT_OK, intent);
	...
	public void testHandleActivityResultWhenRequestIntroAndResultOKThenDoNothing() {
		...
		presenter.handleActivityResult(REQUEST_CODE_INTRO, AppCompatActivity.RESULT_OK, intent);
	...
	public void testHandleActivityResultWhenRequestIntroAndResultSplitScreenNotSupportedThenShowToast() {
		...
		verify(navigator).showToast(R.string.paint_studio_intro_split_screen_not_supported, Toast.LENGTH_LONG);
		verifyZeroInteractions(interactor, navigator);
	}
